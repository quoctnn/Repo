...
export interface Props {
  ...
  onAutocompleteChange:(e: React.KeyboardEvent<{}>) => void
...
export default class AutoComplete extends React.Component<Props, any>  {
    autocompleteState:any
    onChange:(editorState: EditorState) => void
    onArrow:(e: React.KeyboardEvent<{}>, originalEvent:(e: React.KeyboardEvent<{}>) => void, nudge:number) => void
    onUpArrow:(e: React.KeyboardEvent<{}>) => void
    onDownArrow:(e: React.KeyboardEvent<{}>) => void
    onEscape:(e: React.KeyboardEvent<{}>) => void
    onTab:(e: React.KeyboardEvent<{}>) => void
    ...
    constructor(props) 
    {
      ...
      getInsertState(selectedIndex, trigger):InsertState
      {
        const {
          editorState
        } = this.props;
