...
import SideBarContactsContent from "./SideBarContactsContent";
...
export default class SideBarContactsItem extends React.Component<Props, State> {
        ...
        return (
            <div id={this.props.index} className={css} onClick={this.props.onClick}>
                ...
                {this.state.menuItem &&
                    ...
                    ||
                    translate("sidebar.contacts.title")
                }
            </div>
        )
    }
